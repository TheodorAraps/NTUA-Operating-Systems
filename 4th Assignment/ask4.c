...
int main (int argc, char** argv)
{
	...
	Server.sin_addr.s_addr = inet_addr(IP);	//converts the string pointed to by IP, in the Internet standard dot notation, to an integer value suitable for use as an Internet address.
	...
	while(1)
	{
		...
		int N = count_words(input), n_read = 0; 
